...
%                 classifiers{index} = trainSVM(X, y, valX, valy);
                ...
                classifiers{index}.model = fitcecoc(xtrain,ytrain, 'learners', radial, 'ClassNames',[unique(ytrain)]); % SVM
                index = index + 1;
            ...
            case 'RF'
                ...
                classifiers{index}.model =  fitcensemble(X,y,'Method','bag', 'learners');
                index = index + 1;
